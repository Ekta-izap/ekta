...
if (isset($_POST['submit'])) {
    ...
    $qryi = "INSERT INTO blog(user_id,title,description) VALUES({$user_object->user_id},'$_POST[title]','$_POST[description]')";
    ...
    if ($result) {
        ...
        echo 'confirm("***YOU CREATED YOUR BLOG SUCCESSFULLY***")';
        echo '</script>';
...
<form  method="POST">
    ...
    <table border="0">
        ...
        <tr>
            <td colspan="2" align="center"><input class="submit" name="submit" type="submit" value="ADD BLOG"/><a href="list.php"><button  class="submit" class="btn" type="button">HOME</button></a></td>
        </tr>
    </table>
