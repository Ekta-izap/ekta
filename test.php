...
$qrys = "SELECT  blog_id,title,description FROM blog  LIMIT 10";
...
<div class="content-div">
    ...
    for($i=1;$i<=$num;$i++) {
        ...
        <ul style="list-style-type:square;"><h2><li><?php echo $row['blog_id']; ?> <?php echo $row['title']; ?></h2>
    ...
    <div >
        <ul class="pagination">
            <li><a href="list.php">&laquo;</a></li>
            <li><a class="active" href="list.php">1</a></li>
